<<template>
<div>
    <MyHeader page-level=3></MyHeader>
    <Card style="width:100%">      
        <a slot="title" @click="flush">
            <Input v-model="keyword" size="small" icon="search" placeholder="请输入查询关键字..." style="width: 80%"></Input>
        </a>
        <ul>
...
export default {
    ...
    methods: {
        flush() {
            var that = this;
            var url = 'companies?sort=1&page=' + this.page + '&pageSize=20&name=' + this.keyword;
